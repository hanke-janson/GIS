  ...
  init() {
    ...
    var particleSystem = this.scene.primitives.add(
      new Cesium.ParticleSystem({
        image: "Explosion/img/peng6.png", //生成所需粒子的图片路径
        ...
        // 默认爆炸不循环
        loop: _this.viewModel.loop ? _this.viewModel.loop : false,
        //粒子系统发射粒子的时间（秒）
        lifetime: _this.viewModel.lifetime,
        //设置粒子的大小是否以米或像素为单位
        sizeInMeters: true,
        //系统的粒子发射器
