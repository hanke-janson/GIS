var protobufMinimal=require('../ThirdParty/protobuf-minimal');
...
var GoogleEarthEnterpriseTileInformation=require('./GoogleEarthEnterpriseTileInformation');
var isBitSet=require('./isBitSet');
...
var TaskProcessor=require('./TaskProcessor');
    ...
    module.exports= GoogleEarthEnterpriseMetadata;
